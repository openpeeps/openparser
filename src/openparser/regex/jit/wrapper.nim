...
when defined(regexJitDynlib):
  ...
  proc dasm_setup*(Dst: ptr ptr dasm_State; actionlist: pointer) = discard
  proc dasm_growpc*(Dst: ptr ptr dasm_State; maxpc: cuint) = discard
  proc dasm_link*(Dst: ptr ptr dasm_State; szp: ptr csize_t): cint = -1
  proc dasm_encode*(Dst: ptr ptr dasm_State; buf: pointer): cint = -1

  proc regex_prologue*(Dst: ptr ptr dasm_State) = discard
  proc regex_epilogue*(Dst: ptr ptr dasm_State) = discard
  proc regex_emit_char*(Dst: ptr ptr dasm_State; lit: cint; failLabel: cint) = discard
  proc regex_emit_any_char*(Dst: ptr ptr dasm_State; failLabel: cint) = discard
  proc regex_emit_char_class*(Dst: ptr ptr dasm_State; bitmapPtr: uint; negated: cint; failLabel: cint) = discard
  proc regex_emit_escape_class*(Dst: ptr ptr dasm_State; cls: cint; failLabel: cint) = discard
  proc regex_emit_anchor_start*(Dst: ptr ptr dasm_State; failLabel: cint) = discard
  proc regex_emit_anchor_end*(Dst: ptr ptr dasm_State; failLabel: cint) = discard
  proc regex_emit_word_boundary*(Dst: ptr ptr dasm_State; negated: cint; failLabel: cint; lblPrevLoaded: cint; lblCurLoaded: cint) = discard
  proc regex_emit_jmp*(Dst: ptr ptr dasm_State; targetLabel: cint) = discard
  proc regex_split*(Dst: ptr ptr dasm_State; tryFirstLabel: cint; resumeId: cint; resumeTargetLabel: cint; failLabel: cint) = discard
  proc regex_emit_match*(Dst: ptr ptr dasm_State; exitLabel: cint; failLabel: cint; wantFull: cint) = discard
  proc regex_emit_fail_entry_head*(Dst: ptr ptr dasm_State; noMatchLabel: cint; stackBytes: cint) = discard
  proc regex_emit_dispatch_case*(Dst: ptr ptr dasm_State; id: cint; targetLabel: cint) = discard
  proc regex_emit_no_match*(Dst: ptr ptr dasm_State) = discard
  proc regex_define_label*(Dst: ptr ptr dasm_State; label: cint) = discard
  proc get_regex_actions*(): pointer = nil
